      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <Link className="text-blue-800">Harsh</Link>
            <span>on</span>
            <Link className="text-blue-800">Web Design</Link>
            <span>2 days ago</span>
          </div>
          <p className="text-gray-500 font-medium">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium facilis aliquid consequuntur quos culpa error vitae aperiam.</p>
        </div>
